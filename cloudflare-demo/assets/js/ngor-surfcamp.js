...
function initHeader(){const nav=$('#nav');if(!nav)return;let _scrolled=false;const update=()=>{const y=scrollY;const want=_scrolled?y>30:y>50;if(want!==_scrolled){_scrolled=want;nav.classList.toggle('scrolled',_scrolled);}};window.addEventListener('scroll',update,{passive:true});update();}
